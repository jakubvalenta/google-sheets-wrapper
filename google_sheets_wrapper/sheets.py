...
def set_properties(service, spreadsheet_id, title=None, locale=None,
                   time_zone=None, sheet_id=0):
...
def get_filled_rows_count(service, spreadsheet_id, start_row_index=0,
                          sheet_id=0):
...
def move(service, spreadsheet_id, row_count, start_row_index=0,
         sheet_id=0):
...
def auto_resize(service, spreadsheet_id, start_index=0, end_index=None,
                sheet_id=0):
    "Auto resize columns"
    dimensions = {
        'sheetId': sheet_id,
...
def resize_column(service, spreadsheet_id, column_index, size, sheet_id=0):
    ...
    print('Resizing column {}, size: {} px'
          .format(column_index, size))
    _exec(service, spreadsheet_id, requests)


def resize_rows(service, spreadsheet_id, size,
                start_row_index=0, end_row_index=None,
                sheet_id=0):
    ...
    print('Resizing rows from {} to {}, size: {} px'
          .format(start_row_index, end_row_index, size))
    _exec(service, spreadsheet_id, requests)


def highlight_cell(service, spreadsheet_id, row_index, column_index,
                   sheet_id=0):
    border = {
        'style': 'DASHED',
        'width': 2,
        'color': format_color((0, 0, 0))
    }
    borders = format_all_sides(border)

    """Set cells background color to yellow and font weight to bold"""
    format_cell(service, spreadsheet_id, row_index, column_index,
                borders=borders, bold=True,
                sheet_id=sheet_id)


def format_row(service, spreadsheet_id, row_index=None,
               start_column_index=0, end_column_index=None,
               number_format=None,
               horizontal_alignment=None, vertical_alignment=None,
               font_family=None, font_size=None,
               bold=None, italic=None, underline=None,
               background_color=None, borders=None, padding=None,
               wrap_strategy=None,
               sheet_id=0):
    ...
    format_range(service, spreadsheet_id, cell_range,
                 ...
                 borders=borders, padding=padding, wrap_strategy=wrap_strategy)


def format_column(service, spreadsheet_id, column_index,
                  start_row_index=0, end_row_index=None,
                  number_format=None,
                  horizontal_alignment=None, vertical_alignment=None,
                  font_family=None, font_size=None,
...
def format_columns(service, spreadsheet_id,
...
def format_cell(service, spreadsheet_id, row_index, column_index,
                number_format=None,
                horizontal_alignment=None, vertical_alignment=None,
                font_family=None, font_size=None,
                bold=None, italic=None, underline=None,
...
def format_range(service, spreadsheet_id, cell_range=None,
                 number_format=None,
                 horizontal_alignment=None, vertical_alignment=None,
                 font_family=None, font_size=None,
                 bold=None, italic=None, underline=None,
...
def clear_formatting(service, spreadsheet_id,
